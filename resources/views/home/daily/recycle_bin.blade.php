...
@section('content')
    <div class="container">
        ...
        <h2 class="text-center mt-3">Daily Plan Bin</h2>

        <div class="panel mt-3 mb-3">
            <div class="row justify-content-around">
                <div class="col-md-4 d-flex justify-content-center">
                    <form action="{{ route('home.daily.recycle_bin_restore_all') }}" method="post" class="d-inline">
                        @csrf
                ...
                <div class="col-md-4 d-flex justify-content-center">
                    <form action="{{ route('home.daily.recycle_bin_destroy_all') }}" method="post" class="d-inline">
                        @csrf
                ...
                <li class="list-group-item alert">
                    <div class="row">
                        ...
                        <div class="col text-center h3">
                            <form action="{{ route('home.daily.recycle_bin_restore', ['id' => $el->id]) }}" method="post"
                                class="d-inline">
                                @csrf
                                <button type="submit" class="badge alert-success border-0"><i
                                        class="fa-solid fa-recycle mx-2 text-success"></i></button>
                            </form>
                            <form action="{{ route('home.daily.recycle_bin_destroy', ['id' => $el->id]) }}" method="post"
                                class="d-inline">
                                @csrf
